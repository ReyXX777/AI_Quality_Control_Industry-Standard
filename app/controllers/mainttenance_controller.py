...
prediction_counter = Counter('predictive_maintenance_predictions_total', 'Total number of maintenance predictions')
high_risk_prediction_counter = Counter('predictive_maintenance_high_risk_predictions_total', 'Total number of high-risk predictions')
prediction_latency_gauge = Gauge('predictive_maintenance_prediction_latency', 'Latency of maintenance prediction in seconds')
...
async def predict_maintenance(equipment_id: str, alert_recipient: str = None):
    ...
    try:
        ...
        if prediction["risk_score"] > 0.8:
            ...
            high_risk_prediction_counter.inc()
        ...
        prediction_latency_gauge.set(latency)
